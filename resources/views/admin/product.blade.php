                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="product_category" id="exampleFormControlSelect1">
                                ...
                                <option value="office">Interior Decor</option>
                                <option value="books">Cash/Receipt Books</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="product_brand" id="exampleFormControlSelect1">
                                ...
                                <option value="flash">Flash Disks</option>
                                <option value="umbrella">Umbrellas</option>
                                <option value="shirts">Tshirts</option>
                                <option value="carrier">Carrier Bags</option>
                            </select>
                        </div>
                    </div>
