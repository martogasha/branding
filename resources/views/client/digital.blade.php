...
<head>
    ...
    <title>Davix - Digital Marketing</title>
            ...
            <div class="col-lg-9">
                <div class="blog-details">
                    ...
                    <p style="font-size: 20px;font-family:'Nimbus Roman'">Social media is a great platform to generate sales when you have defined goals and objectives
                        ...
                        audience resulting in higher conversion-rates for your digital marketing budget. We take time to
                        understand the client’s requirements, advise on the best course of action and develop digital
                        marketing strategies that will deliver on the current campaign objective
                        We offer social media management and marketing in one-off campaigns or renewable packages (monthly, quarterly or annually).
                        The core social media marketing platforms we use for advertising businesses, services, products, offers or brands are:
                        <br>
                        1. Facebook
                        <br>
                        2. Instagram
